...
class PublicUserApiTests(TestCase):
    ...
    def test_user_with_email_exists_error(self):
        """Test that creating a user with an existing email returns an error."""        # noqa: E501
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
            'name': 'Test User',
    ...
    def test_create_token_bad_credentials(self):
        """Test returns error for invaild credentials while generating token."""        # noqa: E501
    ...
    def test_create_token_blank_password(self):
        """Test returns error for blank password while generating token."""
        payload = {
            'email': 'test@example.com',
            'password': '',
        }
